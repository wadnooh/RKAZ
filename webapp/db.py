...
SOP_ROWS = [
    ("استلام العطل", "مكتب الطوارئ", "رقم العطل، الموقع، نوع العطل", "تسجيل العطل بالتاريخ", "15 دقيقة", "سجل الأعطال الرسمي"),
    ("توجيه الفرقة", "المندوب / المراقب", "بيانات العطل", "تعيين فرقة مناسبة", "15 دقيقة", "وقت التوجيه"),
