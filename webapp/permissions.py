...
PERM_LABELS = {
    ...
    'button.module.hr_leaves.add': 'زر إضافة في إجازات الموظفين',
    'button.module.hr_leaves.delete': 'زر حذف في إجازات الموظفين',
    'button.module.hr_leaves.edit': 'زر تعديل في إجازات الموظفين',
    'button.module.hr_leaves.export': 'زر تصدير Excel في إجازات الموظفين',
    'button.module.hr_leaves.import': 'زر استيراد Excel في إجازات الموظفين',
    ...
    'section.maintenance': 'الأصول الثابتة والورشة',
    ...
    'tab.maintenance': 'تبويب الأصول الثابتة',
    ...
    'tab.module.hr_leaves': 'تبويب/قائمة إجازات الموظفين',
    ...
    'hr.employee.print': 'طباعة بطاقة وملف الموظف',
...
_ROLE_PERMS = {'admin': {'api.access',
           ...
           'button.module.hr_leaves.add',
           'button.module.hr_leaves.delete',
           'button.module.hr_leaves.edit',
           'button.module.hr_leaves.export',
           'button.module.hr_leaves.import',
...
def required_perm_for_request() -> str | None:
    ...
    section_endpoints = {
        ...
        "hr_home": "section.hr",
        "hr_employee_dossier": "section.hr",
        "hr_employee_pdf": "section.hr",
