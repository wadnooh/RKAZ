...
MODULES = {
    ...
    "contractor_supplies": {
        ...
        "fields": [
            ...
            ("contractor", "المقاول", "text"),
            ("ticket_no", "رقم العطل", "ticket"),
            ("work_no", "رقم أمر عمل المقاول", "text"),
    ...
    "new_coordinations": {
        ...
        "fields": [
            ...
            ("project_code", "كود المشروع", "text"),
            ("construction_work_no", "رقم أمر عمل الإنشاءات", "text"),
    ...
    "custody": {
        ...
        "fields": [
            ...
            ("employee", "الموظف", "list:employees"),
            ("item_no", "رقم المادة", "warehouse_item"),
    ...
    "hr_employees": {
        ...
        "fields": [
            ...
            ("profession", "المهنة في الإقامة", "text"),
            ("job_title", "المسمى الوظيفي", "text"),
            ("department", "القسم", "list:hr_departments"),
            ("status", "الحالة", "list:hr_status"),
            ("phone", "الجوال", "text"),
            ("id_number", "رقم الهوية / الإقامة", "text"),
            ("id_expiry_date", "تاريخ انتهاء الإقامة / الهوية", "date"),
            ("driving_license_no", "رقم رخصة القيادة", "text"),
            ("license_expiry_date", "تاريخ انتهاء رخصة القيادة", "date"),
            ("insurance_expiry_date", "تاريخ انتهاء التأمين الطبي", "date"),
            ("contract_end_date", "تاريخ نهاية العقد", "date"),
            ("join_date", "تاريخ الالتحاق", "date"),
            ("basic_salary", "الراتب الأساسي", "number"),
            ("housing_allowance", "بدل السكن", "number"),
            ("other_allowances", "بدلات أخرى", "number"),
            ("bank_name", "اسم البنك", "text"),
            ("iban", "رقم الآيبان", "text"),
            ("emergency_contact_name", "مسؤول الطوارئ", "text"),
            ("emergency_contact_phone", "هاتف الطوارئ", "text"),
            ("notes", "ملاحظات", "textarea"),
        ],
        "list_cols": ["emp_no", "full_name", "job_title", "department", "id_number", "id_expiry_date", "status", "phone"],
    },
    "hr_leaves": {
        ...
        "section": "hr",
        "fields": [
            ("employee_name", "اسم الموظف", "list:employees"),
            ("leave_type", "نوع الإجازة", "list:leave_types"),
            ("start_date", "تاريخ البداية", "date"),
            ("end_date", "تاريخ النهاية", "date"),
            ("days_count", "عدد الأيام", "number"),
            ("substitute_employee", "الموظف البديل", "list:employees"),
            ("status", "الحالة", "list:leave_status"),
            ("actual_return_date", "تاريخ العودة الفعلي", "date"),
            ("notes", "ملاحظات", "textarea"),
        ],
        "list_cols": ["employee_name", "leave_type", "start_date", "end_date", "days_count", "status", "actual_return_date"],
    },
    # ---- العقود ----
    "contracts": {
        "title": "العقود",
    ...
    "reinforcement_works": {
        ...
        "section": "reinforcement",
        "fields": [
            ("rekaz_code", "رقم ركاز", "text"),
            ("work_order", "رقم أمر العمل", "text"),
            ("work_no", "رقم المعاملة / الاسكيمة", "text"),
            ("sap_reservation_no", "رقم حجز الساب", "text"),
            ("notification_no", "رقم الإشعار", "text"),
            ("station_no", "رقم المحطة", "text"),
            ("work_date", "التاريخ", "date"),
